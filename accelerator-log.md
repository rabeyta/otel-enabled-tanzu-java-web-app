...
```json
{
  "projectName" : "otel-enabled-tanzu-java-web-app",
  "buildTool" : "maven",
  "ide" : "intellij",
  ...
  "bsGitRepository" : "github.com?owner=rabeyta&repo=otel-enabled-tanzu-java-web-app",
  "bsGitBranch" : "main"
}
```
## Log
...
┃ ┃ ┃ Debug Adding symbol nativeJavaVersion with value '21'
┃ ┃ ┃ Debug Adding symbol javaVersion with value '21'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->otel-enabled-tanzu-j...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: otel-enabled-tanzu...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=rabeyta&repo=otel-enabled-tanzu-java-web-app'
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[2].delegate.transformations[0].sources[0].validated.delegate.in.apply (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(OpenRewriteRecipe, ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ╺ engine.transformations[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[2].delegate.transformations[0].sources[0].validated.delegate.in.apply.transformations[0] (OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[2].delegate.transformations[0].sources[0].validated.delegate.in.apply.transformations[1] (ReplaceText)
